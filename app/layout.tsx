...
export const metadata: Metadata = {
  title: "Divya Dharshini",
  description: "Immersive portfolio of Divya Dharshini — Software Engineer and Tech Lead. Interactive 3D experiences built with Next.js and React Three Fiber.",
  authors: [{ name: "Divya Dharshini" }],
  openGraph: {
    title: "Divya Dharshini",
